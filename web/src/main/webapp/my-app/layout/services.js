...
define(['angular', 'jquery'], function (angular, $) {
  ...
  return angular.module('my-app.layout.services', [])
    .factory('layoutService', ['$sce', '$http', '$log', 'miscService',
      'mainService', '$sessionStorage', '$q', 'SERVICE_LOC',
      function ($sce, $http, $log, miscService, mainService,
                $sessionStorage, $q, SERVICE_LOC) {
      /**
       * Add a widget to the home layout
       * @param portlet
       * @returns {*}
       */
